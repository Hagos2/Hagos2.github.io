...
const triple1 = imports.triple1;
const triple2 = imports.triple2;
// const triple2 = imports.triple2;
...
describe("myMap", function () {
  ...
  describe("myMap", function () {
    ...
    it("tests myMap on triples anonymous function", function () {
      assert.deepStrictEqual(myMap(testArray, triple1), [-30, 0, 30, 60]);
    });
    it("tests myMap on triples arrow function", function () {
      assert.deepStrictEqual(myMap(testArray, triple2), [-30, 0, 30, 60]);
    });
  });